    ...
    <div className="min-h-screen flex flex-col items-center py-8 px-2">
      <div className="w-full max-w-6xl mx-auto bg-white rounded-2xl shadow-2xl p-4 sm:p-8 md:p-10 animate-fade-in-up transition-transform duration-300">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-blue-900 flex items-center gap-2">
            <svg xmlns='http://www.w3.org/2000/svg' className='h-8 w-8 text-blue-500' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
              <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M9 17v-2a4 4 0 014-4h6m-6 0V7a4 4 0 00-4-4H5a4 4 0 00-4 4v10a4 4 0 004 4h6a4 4 0 004-4z' />
            </svg>
            Pending Deliveries
          </h2>
          <div className="border-b border-gray-200 w-20 my-3" />
          <p className="text-gray-600 text-base sm:text-lg max-w-lg">
            Accept and manage your assigned deliveries below.
          </p>
        </div>
          ...
          <>
            {deliveries && deliveries.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-16">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-20 text-blue-200 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h2l.4 2M7 10h10l1.4 2M17 10h2m-9 4h4m-2 0v2m0-2v-2m0 2h-2m2 0h2" />
                </svg>
